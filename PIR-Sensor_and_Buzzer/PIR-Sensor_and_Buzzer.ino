...
const int BUZZER_PIN = 14;      // กำหนดพินสำหรับ Buzzer
...
String GAS_ID = "AKfycbwTQy7d75Q-W6i5AZ2uDzi1bPGC7F9nbW_kzSXyvoOFBkrX7669kV_E2OGge25WVn-mmw"; // apps script ID or deployment ID
...
void setup() {
  ...
  pinMode(BUZZER_PIN, OUTPUT);     // ตั้งค่า Buzzer เป็น output
